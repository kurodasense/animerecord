...
这个项目我目前是做成了网页的形式，因为在网站上看完一部番后可以直接打开我这个追番记录页面进行记录。但是其实我觉得做成桌面端的优势更大于网页端。如果做成桌面端其实更方便其他人的个人使用。因此，后续打算使用electron来做一个。地址：http://8.134.217.191:8083/
...
* 为什么使用vuex来存放权限状态？
  ...
  * 没有结合localStorage来做持久化存储也是这个原因，但是实际自己在使用的时候也发生了用不习惯的情况，但是目前感觉还好，如果真用不习惯我感觉以后重做算了。
